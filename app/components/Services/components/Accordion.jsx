  ...
  return (
    <div className={`w-full h-full  rounded-full`}>
      ...
      >
        ...
        {/* -[300px] */}
        <div
          className={` z-10 rounded-b-[30px] mt-[-30px]  bg-[#9db218] overflow-hidden transition-all duration-500 ease-in-out text-white text-[20px] text-sm 
        ${accordionOpen ? "max-h-[300px] " : "max-h-0"}`}
        >
          <div
            className={`z-10 pt-[33px] px-[10px] py-[10px] overflow-hidden text-[20px]`}
          >
            {content}
          </div>
        </div>
